# Getting help with malevnc

Thanks for using malevnc. We're sorry if you're having trouble, but don't worry,
...
* Search the flyconnectome or flyem-cns slack channels.
* Search the [nat-user google group](https://groups.google.com/forum/#!forum/nat-user).
* Search GitHub for [_issues_ with the malevnc package](https://github.com/natverse/malevnc/issues).
...
* If you need to report a *new* bug:
  please [file an issue](https://github.com/natverse/malevnc/issues/new).
* If you're not sure:
